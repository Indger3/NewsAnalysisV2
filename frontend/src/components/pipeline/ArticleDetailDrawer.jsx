    ...
    <Stack spacing={3}>
      {data.summary && (
        <Box>
          ...
          <Box sx={{ mt: 0.5, p: 1.5, borderLeft: '3px solid', borderColor: 'primary.main', bgcolor: 'rgba(255,255,255,0.04)', borderRadius: '0 6px 6px 0' }}>
  ...
  return (
    ...
    >
      <Box sx={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
        {/* header */}
        <Box sx={{ px: 2.5, pt: 2, pb: 1, borderBottom: '1px solid rgba(255,255,255,0.06)', display: 'flex', alignItems: 'flex-start', gap: 1 }}>
